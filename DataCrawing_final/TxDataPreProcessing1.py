...
txdata = pd.read_csv("txinBlock.txt",header=None,sep=" ")
...
blockData.to_csv("block2new.csv",index=False,header=False)
txdata.to_csv("txinblock.csv",index=False,header=False)
...
data.to_csv("../txinblock3.csv",index=False,header=False)
